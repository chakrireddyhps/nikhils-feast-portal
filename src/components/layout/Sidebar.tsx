...
// Sidebar always stays dark — it's the brand identity regardless of theme
const S = {
      ...
      <div style={{ borderTop: `1px solid ${S.border}`, padding: collapsed ? '14px 8px' : '14px 16px', flexShrink: 0 }}>
        {!collapsed && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            <div style={{ width: 34, height: 34, borderRadius: 9, flexShrink: 0, background: `linear-gradient(135deg, ${S.burgundy}, #6B1020)`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, fontWeight: 800, color: '#fff' }}>N</div>
            <div>
